...
public class ChangeLimitResponse {
  ...
  private final Optional<Account> previousLimits;

  @JsonProperty("new_limits")
  private final Optional<Account> newLimits;

  public ChangeLimitResponse(Optional<Account> previousLimits, Optional<Account> newLimits) {
    this.previousLimits = previousLimits;
    this.newLimits = newLimits;
  }

  public static ChangeLimitResponse empty(){
    return new ChangeLimitResponse(Optional.of(Account.empty()), Optional.of(Account.empty()));
  }
}
